...
date: 2012-05-21
description: "Practical tips for improving Django app performance, from profiling to QuerySet optimization."
---
...
important. To get a better understanding, read [When QuerySets Are Evaluated](https://docs.djangoproject.com/en/1.1/ref/models/querysets/#when-querysets-are-evaluated) and [Database Access Optimization](https://docs.djangoproject.com/en/1.1/topics/db/optimization/) in the Django
